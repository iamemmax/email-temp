      ...
      <Body className="bg-white">
        <Container>
          ...
          <Section className="mt-8 px-4 md:px-20">
            <Link href="#">
              <Button
                className="bg-[#F0636B] h-[3.25rem] hover:opacity-50 cursor-pointer rounded-[2.5rem] flex justify-center items-center text-white font-bold text-sm"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
                Explore Xtridelink
              </Button>
